...
def main():
    ...
    root = os.path.join('/home/xyl/pysot-master/testing_dataset', args.dataset)
    ...
    if 'OTB' in args.dataset:
        ...
        benchmark.show_result(success_ret, precision_ret,
                              show_video_level=args.show_video_level)
    elif 'VisDrone' in args.dataset or 'LaTOT' in args.dataset:  # xyl
