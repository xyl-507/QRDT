...
def main():
    ...
    dataset_root = os.path.join('/home/xyl/pysot-master/testing_dataset', args.dataset)
    ...
    total_lost = 0
    total_toc = 0  # xyl 20210127 计算fps
    total_idx = 0  # xyl 20210127 计算fps
    if args.dataset in ['VOT2016', 'VOT2018', 'VOT2019']:
        ...
        for v_idx, video in enumerate(dataset):
            ...
            total_idx += idx
            total_toc += toc
        print("{:s} total Speed: {:3.1f}fps".format(model_name, total_idx / total_toc))  # xyl 20210127 计算fps
