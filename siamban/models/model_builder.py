...
from siamban.models.cam import CAM


# from siamban.models.models_mae import random_masking
...
class ModelBuilder(nn.Module):
    ...
    def track(self, x):
        ...
        self.zf_st, xf = self.cam(self.zf, xf)  # xyl 20230303 CAM+template
        # --------------------------------------------------------------CAM
    ...
    def forward(self, data):
        ...
        if cfg.ADJUST.ADJUST:
            ...
            xf = self.neck(xf)
        # ---------------------------------------CAM
        zf, xf = self.cam(zf, xf)  # xyl 20230303 CAM, zf, _ cannot
        # ---------------------------------------
        ...
        # print('cls.loss:{}, loc.loss:{}'.format(cls_loss, loc_loss))
        outputs = {}
